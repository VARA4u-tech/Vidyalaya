  ...
  const handleFileUpload = async (file: File) => {
    ...
    if (file.size > MAX_SIZE) {
      toast.error("File Too Large", {
        description:
          "Please upload a PDF smaller than 10MB for optimal analysis.",
        duration: 4000,
        style: {
    ...
    <div className="flex h-screen w-full overflow-hidden bg-[hsl(210,48%,10%)] text-[hsl(36,25%,90%)] font-sans">
      ...
      >
        ...
        <div className="p-4 border-t border-white/5 space-y-2">
          <button
            onClick={() => navigate("/")}
            className="w-full flex items-center gap-4 px-4 py-3 rounded-xl text-sm text-white/40 hover:text-white hover:bg-white/5 transition-all"
          >
            <ChevronLeft size={20} />
          ...
          <button
            ...
            className="w-full flex items-center gap-4 px-4 py-3 rounded-xl text-sm text-[hsl(9,70%,60%)] hover:bg-[hsla(9,70%,54%,0.1)] transition-all"
          >
            <LogOut size={20} />
          ...
          <div className="flex items-center gap-4 relative">
            <AnimatePresence>
              {uploadedFile && activeStep !== "upload" && (
                ...
                >
                  ...
                  <span className="text-xs font-black text-coral-400 max-w-[180px] truncate uppercase tracking-tighter">
                    {uploadedFile.name}
                  </span>
                </motion.div>
              )}
            ...
            >
              ...
              <div className="hidden sm:flex flex-col items-start leading-none gap-1">
                ...
                <span
                  className={`text-[9px] font-black uppercase tracking-widest ${isProfileOpen ? "text-coral-400" : "text-white/30"}`}
                >
                  Account
                </span>
              </div>
                  ...
                  <div
                    ...
                    className={`relative w-full max-w-2xl aspect-video md:aspect-[21/9] rounded-[3rem] border-2 border-dashed transition-all duration-500 flex flex-col items-center justify-center gap-6 group cursor-pointer overflow-hidden ${
                      isProcessing
                        ...
                        : "border-white/10 hover:border-coral-500/40 hover:bg-white/[0.04] active:scale-[0.98]"
                    }`}
                  >
                    <input
                      id="file-upload"
                    ...
                    {isProcessing ? (
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <p className="font-black text-coral-500 animate-pulse tracking-[0.3em] text-[10px] uppercase">
                      ...
                      <>
                        <div className="w-24 h-24 rounded-3xl bg-white/5 flex items-center justify-center group-hover:scale-110 group-hover:bg-coral-500/20 transition-all duration-500 border border-white/5 shadow-2xl group-hover:border-coral-500/30">
                          <Upload
                            size={40}
                            className="text-white/30 group-hover:text-coral-500"
                          />
                        </div>
                  ...
                  <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Complex topics broken down into easy-to-understand points.",
                      },
                      {
                        icon: Clock,
                        title: "Study Planner",
                        desc: "Create a personalized schedule for your exams.",
                      },
                    ].map((feat, i) => (
                      <div
                        key={i}
                        className="p-8 rounded-3xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.05] transition-all flex flex-col gap-4"
                      >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-white/5">
                    <div className="text-center md:text-left">
                      ...
                      <p className="text-white/40 font-medium">
                        Revisit and refine your previous study sessions.
                      </p>
                    </div>
                    <div className="relative group w-full md:w-auto mt-4 md:mt-0">
                      <Search
                        className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-coral-400 transition-colors"
                        size={18}
                      />
                      <input
                        type="text"
                  ...
                  {history.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                      {history.map((doc, i) => (
                        ...
                        >
                          ...
                          <h3 className="font-bold text-xl mb-3 truncate pr-10">
                            {doc.name}
                          </h3>
                    ...
                    <div className="flex flex-col items-center justify-center py-32 gap-6 text-white/10">
                      ...
                      <p className="text-2xl font-serif italic">
                        Your library awaits its first document.
                      </p>
                    </div>
                  )}
                </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 gap-8">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-white/30 uppercase tracking-[0.4em] text-[10px] font-black">
                          AI is organizing your study notes...
                        </p>
                      </div>
                    </div>
                  ) : (
                        ...
                        <div className="flex-1 space-y-10">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-10 rounded-[3rem] bg-[hsl(185,48%,15%)] border border-[hsl(185,48%,50%,0.2)] shadow-2xl">
                              ...
                              <div className="flex flex-wrap gap-2.5">
                                {analysis.concepts.map((c) => (
                                  <span
                                    key={c}
                                    className="px-4 py-2 rounded-2xl bg-white/5 border border-white/10 text-xs font-bold text-white/60 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all cursor-default shadow-sm"
                                  >
                                    {c}
                                  </span>
                                ))}
                            ...
                            <div className="p-10 rounded-[3rem] bg-white/5 border border-white/5 flex items-center justify-between shadow-xl">
                              <div>
                                <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 mb-3">
                                  Material Depth
                                </h4>
                          ...
                          <div className="space-y-8">
                            {[
                              ...
                              <div key={i} className="flex gap-5">
                                ...
                                <p className="text-sm text-white/60 leading-[1.7] font-bold">
                                  {tip}
                                </p>
                              </div>
                            ))}
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-white/10">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <h5 className="text-[11px] font-black uppercase tracking-[0.3em] text-white/30">
                        Library Overview
                      </h5>
                      <button
                        onClick={() => {
                    ...
                    {history.length > 0 ? (
                          ...
                          >
                            <div className="flex items-center gap-4 min-w-0">
                              ...
                              <div className="min-w-0">
                                <p className="text-sm font-bold truncate pr-4 text-white/90">
                                  {doc.name}
                                </p>
                      ...
                      <div className="p-10 text-center border-2 border-dashed border-white/5 rounded-[2.5rem]">
                        <p className="text-sm text-white/20 font-bold">
