    ...
    <div className="relative z-10">
      <div className="flex items-center gap-5 mb-6">
        ...
        <div>
          ...
          <p
            className="font-sans font-medium text-xs mt-1 uppercase tracking-wider"
            style={{ color: color }}
          >
            {member.role}
          </p>
...
const DepartmentBlock = ({
  ...
  >
    <div className="flex items-center gap-4 mb-4">
      ...
      <div>
        <h3 className="font-serif font-bold text-2xl text-[hsl(210,48%,20%)]">
          {title}
        </h3>
        <div
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="font-sans font-bold uppercase tracking-[0.3em] text-coral-600 text-[10px]">
            Development Force
          </span>
          <h2 className="font-serif font-bold text-4xl md:text-6xl text-[hsl(210,48%,20%)] mt-4">
            Meet{" "}
            <span className="italic text-coral-500 underline decoration-coral-500/30 underline-offset-8">
              Team Varanasi
            </span>
          </h2>
          <p className="font-sans text-[hsl(210,48%,30%)] mt-6 max-w-2xl mx-auto opacity-70 leading-relaxed">
            A collaborative powerhouse of four dedicated engineers working
            together to redefine the student learning experience through AI
            innovation.
          </p>
        </motion.div>
